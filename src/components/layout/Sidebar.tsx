...
export const Sidebar: React.FC<SidebarProps> = ({ isMobileOpen, toggleMobileSidebar }) => {
  return (
    <>
      ...
      <aside 
        className={cn(
          "fixed inset-y-0 left-0 z-30 w-64 bg-white dark:bg-slate-900 text-slate-700 dark:text-white transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static",
      ...
      >
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4">
          <div className="flex items-center gap-2 rounded-md bg-gradient-to-r from-purple-100 to-orange-100 dark:from-purple-900/50 dark:to-orange-900/50 p-3">
            <img 
              src="/EduMotionLogo.png" 
              alt="EduMotion Logo" 
              className="h-8 w-auto"
